...
# app = dash.Dash(__name__, prevent_initial_callbacks=True, external_stylesheets=[dbc.themes.BOOTSTRAP,dbc_css])
#
...
#
# @app.callback(
#     Output('custom', component_property='figure',allow_duplicate=True),
#     Input('btn-bb', component_property='n_clicks'),
#     Input('radio_collection', component_property='value'),
#     prevent_initial_call=True
# )
# def update_graph(btn_bb, radio_collection_v):
#     old_button_id = 0
#     print(type(btn_bb))
#
#     if btn_bb > old_button_id:
#         trades, data = graf.backtest_bollinger_band(collection=radio_collection_v, period=1, window=7)
#     fig = plot_the_strategy(data, plotted=False)
#     return fig
#
#
# @app.callback(
...
#     prevent_initial_call=True
# )
# def update_layout(btn_btf, radio_collection_v):
#     old_button_id = 0
#     print(type(btn_btf))
#     if btn_btf > old_button_id:
#         trading_data = btf_s.buy_sell(collection=radio_collection_v, days=5, period=1)
#     print("111111",trading_data)
#     fig = plot_data(trading_data, plotted=False)
#     return fig
#
